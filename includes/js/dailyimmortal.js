    ...
    for (countdownElement of document.querySelectorAll('p.opencountdown')){
        ...
        if (countdownElement.dataset.day !== "undefined"){
            ...
            if (!openDays.includes(String(currentDay))) {
                ...
                countdownElement.textContent = "Cerrado por hoy" //todo: set actual time
                continue;
            }
        }
        ...
        for (openTime of splittedId){
            ...
            if((serverTime.getTime() >= startTime.getTime() && serverTime.getTime() <= endTime.getTime() )){
                ...
                countdownElement.textContent ="Cierra en: " + (timeparts[1] > 0 ? (timeparts[1] + 'h ') : '') + timeparts[2] + 'm ' + timeparts[3] + 's';
                break;
            } else{
                ...
                if(remainingtime > 0){
                    countdownElement.textContent ="Abre en: " + (timeparts[1] > 0 ? (timeparts[1] + 'h ') : '') + timeparts[2] + 'm ' + timeparts[3] + 's';
                    break;
                }
                else {
                    countdownElement.textContent = "Cerrado por hoy" //todo: set actual time
